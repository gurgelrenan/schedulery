...
class SchedulesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create schedule" do
    assert_difference('Schedule.count') do
      post schedules_url, params: { schedule: { lead_id: @schedule.lead_id, sent_at: @schedule.sent_at } }
    end
  ...
  test "should update schedule" do
    patch schedule_url(@schedule), params: { schedule: { lead_id: @schedule.lead_id, sent_at: @schedule.sent_at } }
